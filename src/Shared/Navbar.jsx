...
import logo from "../assets/your-dream-coffee-logo.webp";
        ...
        <div className="flex items-center gap-3">
          <Link className="flex justify-center items-center">
            <motion.figure>
              <PhotoView src={logo}>
                <img
                  className="w-24 h-14  md:w-60 md:h-20 hidden md:block"
                  src={logo}
                  alt="logo"
                />
              </PhotoView>
      ...
      <div className="navbar-end">
        <div className="dropdown dropdown-end flex items-center">
          ...
          <label tabIndex={0} className="btn btn-ghost btn-circle avatar">
            {user ? (
              <motion.div className="w-6 md:w-10 rounded-full">
          ...
          {user ? (
            ...
            <motion.button
              ...
              className="btn bg-gray-700 border-none text-white px-7"
            >
